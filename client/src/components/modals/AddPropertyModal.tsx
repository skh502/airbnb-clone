      ...
      {currentStep == 1 ? (
        ...
        <>
          ...
          <div className="pt-3 pb-6 space-y-4">
            ...
            {dataImage && (
              <div className="w-[200px] h-[150px] relative flex">
                <Image
                  fill
                  alt="Uploaded image"
                ...
                <button
                  ...
                  className="absolute right-0 rounded-full bg-red-300 px-1 text-black cursor-pointer hover:bg-red-400 text-[12px]"
                >
                  X
                </button>
              </div>
